                        ...
                        <div class="col-md-12 form-group">
                            <div class="row">
                                ...
                                <div class="col-md-2 form-group">
                                    <input name="StorageStaffEditPersonalInfoSubmit" class="form-control btn btn-primary" type="submit" value="Update">
                                </div>
                                <div class="col-md-2 form-group">
                ...
                <div class="table-wrapper">
                    ...
                    <form class="row" action="profile" method="POST" style="width: 100%">
                        ...
                        <div class="col-md-2 form-group" style="margin-top: 23px "> 
                            <input name="StorageStaffUpdateEmailSubmit" class="form-control btn btn-primary" type="submit" value="Update email">
                        </div>
                    </form>
                </div>
                    ...
                    <form class="row" action="profile" method="POST">
                        ...
                        <div class="col-md-12 form-group">
                            <div class="row">
                                ...
                                <div class="col-md-2 form-group">
                                    <input name="StorageStaffChangePasswordSubmit" class="form-control btn btn-primary" type="submit" value="Update">
                                </div>
                                <div class="col-md-2 form-group">
                                    <a class="form-control btn btn-primary" href="${pageContext.request.contextPath}/home">Cancel</a>
                                </div>
